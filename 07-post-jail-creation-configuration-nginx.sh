...
zfs set jailed=on ${datazpool}/freshports/$WEB_JAIL/var/db/freshports/cache
...
do
   ...
   jexec $WEB_JAIL chown www:freshports /var/db/freshports/var/db/freshports/cache/$set
