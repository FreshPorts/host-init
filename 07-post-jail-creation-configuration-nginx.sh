...
#
#zfs mount ${datazpool}/freshports/$INGRESS_JAIL/var/db/freshports/cache/html 
#zfs mount ${datazpool}/freshports/$INGRESS_JAIL/var/db/freshports/cache/spooling
#zfs mount ${datazpool}/freshports/$INGRESS_JAIL/var/db/freshports/message-queues
#zfs mount ${datazpool}/freshports/$INGRESS_JAIL/var/db/freshports/repos
#zfs mount ${datazpool}/freshports/$INGRESS_JAIL/var/db/ingress/message-queues
#zfs mount ${datazpool}/freshports/$INGRESS_JAIL/var/db/ingress/repos
